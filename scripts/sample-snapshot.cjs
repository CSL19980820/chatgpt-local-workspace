...
module.exports=function sampleSnapshot(){
  const activity=[
    ...
    call('c13','file_info','E:/workspace/local-workspace/dist-next/LocalWorkspace.exe',4*minute,1,{kind:'info',session_id:null,summary:'LocalWorkspace.exe',info:[{label:'路径',value:'E:/workspace/local-workspace/dist-next/LocalWorkspace.exe',mono:true},{label:'类型',value:'文件',mono:false},{label:'大小',value:'292.5 KB',mono:false},{label:'修改时间',value:'2026-09-16T09:49:26Z',mono:false}]}),
